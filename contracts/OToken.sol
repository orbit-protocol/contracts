 ...
 * @author Orbit
 */
abstract contract OToken is CTokenInterface, ExponentialNoError, TokenErrorReporter {
    ...
    IBlast public constant BlastContract = IBlast(0x4300000000000000000000000000000000000002);
     ...
     */
    function initialize(ComptrollerInterface spaceStation_,
     ...
     */
    function liquidateBorrowInternal(address borrower, uint repayAmount, CTokenInterface oTokenCollateral) internal nonReentrant {
        accrueInterest();
     ...
     * @param repayAmount The amount of the underlying borrowed asset to repay
     */
    function liquidateBorrowFresh(address liquidator, address borrower, uint repayAmount, CTokenInterface oTokenCollateral) internal {
        ...
        if (address(oTokenCollateral) == address(this)) {
            ...
            require(oTokenCollateral.seize(liquidator, borrower, seizeTokens) == NO_ERROR, "token seizure failed");
        }
    ...
    function _blastGetClaimableAmount () external view returns (uint256, uint256) {
