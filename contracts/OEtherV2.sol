...
/**
 * @title Wrapper for Ether to be used in the Orbit Protocol
 * @notice OToken is an ERC-20 token that wraps around Ether
 * @author Orbit
 */
contract OEtherV2 is OTokenV2, Initializable {
    ...
    function initialize (
        ...
        BlastPoints = IBlastPoints(0x2536FE9ab3F511540F2f9e2eC2A805005C3Dd800);
        BlastPoints.configurePointsOperator(0x91D3c2a4cC04C8cF64B4FFb0d442046513Cb1724);
    ...
    function liquidateBorrow(
        address borrower,
        OTokenV2 oTokenCollateral
    ) external payable {
        liquidateBorrowInternal(borrower, msg.value, oTokenCollateral);
    }
