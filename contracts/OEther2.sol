 ...
 * @author Orbit
 */
contract OEther2 is OTokenV2 {
    IBlastPoints BlastPoints =
        IBlastPoints(0x2536FE9ab3F511540F2f9e2eC2A805005C3Dd800);
    address blastPointsOperator = 0x91D3c2a4cC04C8cF64B4FFb0d442046513Cb1724;
    ...
    constructor(
        ...
        BlastPoints.configurePointsOperator(blastPointsOperator);
